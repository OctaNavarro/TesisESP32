...
#define LEQ_PERIOD        0.5          // second(s)(valor original 1, lo cambio a 0.125 y muestra lecturas con menor tiempo de integracion)
...
#define MIC_REF_DB        93.0        // Value at which point sensitivity is specified in datasheet (dB)
